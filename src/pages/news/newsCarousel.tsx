            ...
            {news && Array.from(news)?.map((item, index) => (
                ...
                >
                    ...
                    >
                        ...
                        />
                        <span className="font-bold text-xl text-white absolute bottom-5 opacity-100 group-hover:opacity-0 group-hover:invisible visible transition-all truncate-2 text-center duration-300">
                            {item?.titleUz}
                        </span>
