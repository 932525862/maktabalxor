  ...
  return (
    <div className="bg-white p-6 sm:p-8 md:p-12 lg:p-16 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        >
          <h2 className="text-4xl font-serif font-bold text-red-600 mb-6">AGRO-GENESIS</h2>
        ...
        <motion.div
          ...
          transition={{ duration: 1 }}
        >
          <h2 className="text-4xl font-serif font-bold text-red-600 mb-6">MIDDLE AGES</h2>
          <p className="text-lg font-sans text-gray-700 leading-relaxed">
