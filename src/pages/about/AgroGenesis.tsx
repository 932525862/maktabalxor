    ...
    <div className="bg-white p-6 sm:p-8 md:p-12 lg:p-16 max-w-6xl mx-auto">
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            {[{ img: Img1, title: "about.titleQ1", desc: "about.titleQ1p" },
              { img: Img2, title: "about.titleQ2", desc: "about.titleQ2p" }].map((item, index) => (
              <>
                <motion.div
                  key={index}
                ...
                >
                  <h2 className="text-3xl sm:text-3xl md:text-2xl lg:text-3xl font-serif font-bold text-[#7f103a] mb-6">
                    {t(item.title)}
                  </h2>
