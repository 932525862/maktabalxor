  ...
  return (
    <>
      <div className="container max-w-7xl h-full w-full mx-auto flex flex-col justify-between">
        <div className="uppercase flex justify-center items-center h-[130px] text-4xl rounded-3xl mt-5 text-white font-bold bg-[url('/assets/bg.jpg')]" style={{ backgroundImage: `url(${bg})` }}>Products</div>
