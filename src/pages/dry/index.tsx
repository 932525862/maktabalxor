  ...
  return (
    <>
      <div className="container max-w-7xl h-full w-full mx-auto flex flex-col justify-between">
        <div className="uppercase text-center flex justify-center items-center h-[130px] text-2xl md:text-4xl rounded-3xl mt-5 text-white font-bold bg-[url('/assets/bg.jpg')]" style={{ backgroundImage: `url(${bg})` }}>Dried Products</div>
